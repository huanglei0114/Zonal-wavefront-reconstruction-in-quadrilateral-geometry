function z_tfli2i  = tfli2i(sx, sy, x, y)
%TFLI2I Traditional Finite-difference-based Least-squares Integration in 
%   quadrilateral geometry (interpolation before and after).
%   D * Z = G.
% 
%   Reference:
%   [1] W.H. Southwell, "Wave-front estimation from wave-front slope 
...
zr_tfli2 = tfli2(sxr, syr, xr, yr);
warning('on','MATLAB:rankDeficientMatrix');


% Interpolation on height..................................................
vr = isfinite(sxr) & isfinite(syr) & isfinite(xr) & isfinite(yr);
Fzr = scatteredInterpolant(xr(vr),yr(vr),zr_tfli2(vr),'natural');
z_tfli2i = Fzr(x, y); 
